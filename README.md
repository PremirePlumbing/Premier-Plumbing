...
<body>
  ...
  <section id="services">
    ...
    <div class="card">
      <h3>Maintenance</h3>
      <p>Keep your home plumbing running smoothly with regular inspections.</p>
    </div>
  </section>

  <section id="about">
    <h2>About Us</h2>
    <p>At Premier Plumbing, we’ve been serving the community for over 15 years. Our licensed team is committed to quality service and customer satisfaction.</p>
  </section>
